...
@section("contentheader_title", trans("admin.Organizations"))
@section("contentheader_description", trans("admin.organizations listing"))
@section("section", trans("admin.Organizations"))
@section("sub_section", trans("admin.Listing"))
@section("htmlheader_title", trans("admin.Organizations Listing"))

@section("headerElems")
@la_access("Organizations", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">{{trans("admin.Add Organization")}}</button>
@endla_access
@endsection
