...
@section("contentheader_title", trans("admin.Menus"))
@section("contentheader_description", trans("admin.Editor"))
@section("section", trans("admin.Menus"))
@section("sub_section", trans("admin.Editor"))
@section("htmlheader_title", trans("admin.Menu Editor"))
