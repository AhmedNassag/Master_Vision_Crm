...
@section("contentheader_title", trans("admin.Uploads"))
@section("contentheader_description", trans("admin.Uploaded images & files"))
@section("section", trans("admin.Uploads"))
@section("sub_section", trans("admin.Listing"))
@section("htmlheader_title", trans("admin.Uploaded images & files"))
