...
@section("contentheader_title", trans("admin.Modules"))
@section("contentheader_description", trans("admin.modules listing"))
@section("section", trans("admin.Modules"))
@section("sub_section", trans("admin.Listing"))
@section("htmlheader_title", trans("admin.Modules Listing"))

@section("headerElems")
<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">{{trans("admin.Add Module")}}</button>
@endsection
