...
@section("contentheader_description", trans("admin.Meetings listing"))
@section("section", trans("admin.Meetings"))
@section("sub_section", trans("admin.Listing"))
@section("htmlheader_title", trans("admin.Meetings Listing"))

@section("headerElems")
@can("Meetings-create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">{{trans('admin.Add Meeting') }}</button>
@endcan
@endsection
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">{{ trans('admin.Add Meeting') }}</h4>
			</div>
			{!! Form::open(['route' => config('laraadmin.adminRoute').'.meetings.store', 'id' => 'meeting-add-form', 'files'=>true]) !!}
