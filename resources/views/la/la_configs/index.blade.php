	...
	<div class="box box-warning">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="Currency Symbol" maxlength="100" name="currency_symbol" value="{{$configs->currency_symbol}}">
			</div>
		</div><!-- /.box-body -->
