    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#home" class="smoothScroll">{{ trans('admin.home') }}</a></li>
                <li><a href="#about" class="smoothScroll">{{ trans('admin.About') }}</a></li>
                <li><a href="#contact" class="smoothScroll">{{ trans('admin.Contact') }}</a></li>
            </ul>
