...
class CreateMeetingNotesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Meeting_notes", 'meeting_notes', 'follow_date', 'fa-sticky-note-o', [
            ["meeting_id", "meeting", "Dropdown", false, "", 0, 0, true, "@meetings"],
            ["notes", "notes", "Textarea", false, "", 0, 0, true],
            ["follow_date", "Follow date", "Date", false, "", 0, 0, true],
